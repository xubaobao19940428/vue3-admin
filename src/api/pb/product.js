...
export function brandInfoGet(params) {
    ...
    const req = request.create('SupplierBrandListReq', params)
    return request('product', 'SupplierProductService.SupplierBrandList', req, 'SupplierBrandListResp')
};
 ...
 * @returns
 */
export function supplierProductListByCondition(params) {
    const req = request.create('SupplierProductQueryReq', params);
    return request('product', 'SupplierProductService.SupplierProductListByCondition', req, 'product.SupplierProductListResp')
};
...
export function batchOnShelveCheck(params) {
    ...
    return request('product', 'SupplierProductService.BatchOnShelveCheck', req, 'product.BatchOnShelveCheckResp')
};
...
export function batchOnShelve(params) {
    ...
    return request('product', 'SupplierProductService.BatchOnShelve', req, 'product.BatchOnShelveResp')
};
...
export function batchOffShelve(params) {
    ...
    return request('product', 'SupplierProductService.BatchOffShelve', req, 'product.BatchOffShelveResp')
};
...
export function changeSaleStatus(params) {
    ...
    return request('product', 'SupplierProductService.ChangeSaleStatus', req, 'product.ChangeSaleStatusResp')
};
...
export function productExport(params) {
    const req = request.create('SupplierProductQueryReq', params)
    return request('product', 'SupplierProductService.ProductExport', req, 'product.ProductExportResp')
};
 ...
 * @returns
 */
export function viewProductInfoById(params) {
    console.log(params)
    const req = request.create('ViewProductInfoReq', params)
    return request('product', 'ProductService.ViewProductInfo', req, 'product.ViewProductInfoResp')
};
 ...
 * @returns
 */
export function updateSupplierDraft(params) {
    console.log(params)
    const req = request.create('UpdateDraftReq', params)
    return request('product', 'SupplierProductService.UpdateSupplierDraft', req, 'product.UpdateDraftResp')
};
...
export function getSupplierInfo(params) {
    console.log(params)
    const req = request.create('GetSupplierInfoReq', params)
    return request('product', 'SupplierProductService.GetSupplierInfo', req, 'product.GetSupplierInfoResp')
};
 ...
 * @returns
 */
export function submitSupplierDraftById(params) {
    console.log(params)
    const req = request.create('SubmitSupplierDraftByIdReq', params)
    return request('product', 'SupplierProductService.SubmitSupplierDraftById', req, 'product.SubmitSupplierDraftByIdResp')
};
 ...
 * @returns
 */
export function supplierBatchOnShelve(params) {
    console.log(params)
    const req = request.create('BatchOnShelveReq', params)
    return request('product', 'SupplierProductService.BatchOnShelve', req, 'product.BatchOnShelveResp')
};
 ...
 * @returns
 */
export function supplierBatchOffShelve(params) {
    console.log(params)
    const req = request.create('BatchOnShelveReq', params)
    return request('product', 'SupplierProductService.BatchOffShelve', req, 'product.BatchOffShelveResp')
};
 ...
 * @returns
 */
export function supplierChangeSaleStatus(params) {
    console.log(params)
    const req = request.create('ChangeSaleStatusReq', params)
    return request('product', 'SupplierProductService.ChangeSaleStatus', req, 'product.ChangeSaleStatusResp')
};
 ...
 * @returns
 */
export function deleteProductForDisabled(params) {
    console.log(params)
    const req = request.create('SupplierDraftDeleteReq', params)
    return request('product', 'SupplierProductService.SupplierDraftDeleteById', req, 'product.SupplierDraftDeleteResp')
};
